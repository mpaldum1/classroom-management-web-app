...
const sequelize = new Sequelize("DBWT19","root","root",{host:"127.0.0.1",dialect:"mariadb",logging:false});
// mysql -> mariadb
...
db.rezervacija.belongsTo(db.osoblje, {as:'osobljeRezervacija',foreignKey:'osoba'});
