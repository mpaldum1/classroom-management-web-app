...
let Kalendar = (function () {
    ...
    function obojiZauzecaImpl(kalendarRef, mjesec, sala, pocetak, kraj) {
        ...
        filterLista.forEach(element => {
            ...
            if (element.datum != undefined && trenutniMjesec == mjesec) {
    ...
    nazivForma.addEventListener("change", function () {
        ...
        filterLista = listaZauzeca.filter(function (element) {
            return element.naziv === nazivForma.value;
        });
    ...
    periodicnaForma.addEventListener("change", function () {
        ...
        filterLista = listaZauzeca.filter(function (element) {
            if (periodicnaForma.checked) {                      // trazimo li periodicne
                return element.dan != undefined;                // moraju imati definisan pocetni dan
            }
            else {
                return element.dan == undefined;
            }
        });
    ...
    function filtrirajVrijeme() {
        filterLista = listaZauzeca.filter(function (element) {
            return porediVrijeme(element.pocetak, krajPretrage) <= 0 && porediVrijeme(pocetakPretrage, element.kraj) <= 0;
...
Kalendar.ucitajPodatke([new periodicnaZauzeca(2, "zimski", "17:30", "22:30", "0-01", "Arslan"), new periodicnaZauzeca(2, "zimski", "12:50", "17:30", "0-01", "Arslan")],
    [new vanrednaZauzeca("05.10.2019.", "12:50", "17:30", "0-01", "Lol"), new vanrednaZauzeca("05.09.2019.", "12:50", "17:30", "0-01", "Lol"), new vanrednaZauzeca("05.10.2019.", "12:50", "17:30", "0-01", "Lol")]);
